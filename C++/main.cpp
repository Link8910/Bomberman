...
int main()
{
	...
	while (p1.vida == true)
	{
		...
		if (p_enemigo[0]->vida == false  and  p_enemigo[1]->vida == false and p_enemigo[2]->vida == false and p_enemigo[3]->vida == false) 
		{
		...
		if (p_enemigo[0]->vida == false  and  p_enemigo[1]->vida == false and p_enemigo[2]->vida == false and p_enemigo[3]->vida == false and p_boss[0]->vida == false and p1.vida == true) 
		{
